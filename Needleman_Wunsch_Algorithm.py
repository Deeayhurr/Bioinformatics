...
class Needleman_algorithm:
    ...
    def getSequenceinfo(self):
                        ...
                        with open(config_file, "r") as conf:
                            ...
                            try:
                                for count,row in enumerate(rows) :
                                    ...
                                    if count == 3:
                                        max_seq_length = int(row)
                                        print(f"Maximum number of sequence length is {max_seq_length}")
                                    if count == 4:
                    ...
                    with open(first_sequence, "r") as f_seq:
                        ...
                        for sequence in sequences_1:
                            ...
                            if position < sequence.find('\n'):
                                ...
                                if length_sequence > max_seq_length:
                                    raise ValueError(f"The sequence length is {length_sequence} and it  has exceeded" 
                                    f"{max_seq_length} the maximum number of sequence length." 
                    ...
                    with open(second_sequence, "r") as s_seq:
                        ...
                        for sequence in sequences_2:
                            ...
                            if position < sequence.find('\n'):
                                ...
                                if length_sequence_2 > max_seq_length:
        ...
        zero_matrix = np.zeros((length_sequence+1,length_sequence_2+1))
